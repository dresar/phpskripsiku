<?php
/**
 * API: History - 50 data terakhir (bisa filter tanggal)
 * GET /api/history.php?limit=50&date_from=2025-03-01&date_to=2025-03-03
 */
...
try {
    ...
    $rows = $repo->getHistory($limit, $dateFrom, $dateTo);
    // Urutan untuk chart: oldest first
